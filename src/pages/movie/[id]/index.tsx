...
import { DialogWithRating } from '@/components/Dialog'
...
import { Add, ArrowBack, Check, StarRateRounded } from '@mui/icons-material'
        ...
        <div className="absolute bottom-4 left-4 text-white">
          ...
          <Stack direction="row" alignItems="center" spacing={2}>
            <Typography
              ...
              variant="body2"
            >
              <StarRateRounded className="text-[#D9A931]" fontSize="small" />
